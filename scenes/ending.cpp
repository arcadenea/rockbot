...
void ending::bosses() const
{
    ...
    boss_credits(APEBOT, fio.read_stage_boss_id(APEBOT));
    boss_credits(TECHNOBOT, fio.read_stage_boss_id(TECHNOBOT));
    boss_credits(DYNAMITEBOT, fio.read_stage_boss_id(DYNAMITEBOT));
    boss_credits(DAISIEBOT, fio.read_stage_boss_id(DAISIEBOT));
    boss_credits(SPIKEBOT, fio.read_stage_boss_id(SPIKEBOT));
    boss_credits(MUMMYBOT, fio.read_stage_boss_id(MUMMYBOT));
    boss_credits(SEAHORSEBOT, fio.read_stage_boss_id(SEAHORSEBOT));
    boss_credits(MAGEBOT, fio.read_stage_boss_id(MAGEBOT));
